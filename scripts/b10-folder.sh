...
mkdir -p /root/output/loot/intern/rpc/shadowcoerce
...
mkdir -p /root/output/loot/intern/ad/iam/laps
mkdir -p /root/output/loot/intern/ad/iam/ntlm_auth
mkdir -p /root/output/loot/intern/ad/iam/passpol
...
mkdir -p /root/output/loot/intern/ad/iam/user_as_pass
...
mkdir -p /root/output/loot/intern/mitm/nbt_llmnr
